    ...
    <div className="content">
      <div className="left-side">
        <div className="address details">
          ...
          <div className="text-one">KOVAIPUDUR</div>
          <div className="text-two">COIMBATORE</div>
        </div>
        ...
        <div className="email details">
          ...
          <div className="text-one">wanderlenses@gmail.com</div>
          <div className="text-two">info.flytographer@gmail.com</div>
        </div>
      </div>
