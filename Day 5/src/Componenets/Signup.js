...
import { addUser } from '../Componenets/state/index';
...
function Signup() {
  ...
  return (
    ...
    <section>
    <div class="imgBx">
        <img alt='img' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcROzHof-2Bmil1PxV8_-FFrftITzN2i2g6xgNwcuCZygrzwCKLpdLgUsqTMyv8wyrLJZ2s&usqp=CAU"/>
    </div>
    <div class="contentBx">
        <div class="formBx">
